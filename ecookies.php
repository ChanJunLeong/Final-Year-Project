...
<body>
  ...
  <section class="home-section">
    ...
    <form method="POST">
      ...
      <label for="name">Cookies ID:</label>
      <input type="text" name="coid"  placeholder="Cookies ID to be delete" required/><br><br>
      ...
      <input type="submit" value="Delete Cookies" name="submit">
        <br>
        <br>
...
<?php
        function button1()
        {
            ...
            if($Spass == $pass2)
            {
                    $sql = "UPDATE cookies SET Cok_statu = 'SO' WHERE Cok_ID = '".$COid."'";
