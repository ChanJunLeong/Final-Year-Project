...
<div class="shopping-cart">
    ...
    <div class="item">
        <div class="image">
            <img src="image/<?php echo $CIMG; ?>" width="200" height="200"/>
        </div> 
        <div class="description">
            <h3>Product Details:</h3>
            <p style="color: darkcyan"><?php echo $CN;?></p>
            <p style="color: darkcyan"><?php echo $CS;?> inch</p>
            <p style="color: darkcyan">RM<?php echo $CP;?> per one</p>
        </div>
         <div class="quantity">
            <h3>Purchase Quantity:</h3>
            <p><?php echo $quan;?></p>            
            <h3>Total Amount:</h3>
            <p>RM<?php $TA = $CP*$quan; echo $TA;?></p>
        </div>
    </div>
</div>
<form method="POST" name="a" action="recipt.php">
    <div class="content">
        ...
        <input type="hidden" name="cname" value="<?php echo $CN; ?>">
