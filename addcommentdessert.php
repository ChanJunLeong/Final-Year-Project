    ...
    ?>
		<div class="form-container">
            ...
            <div class="buyh">
                <?php
                    include 'database.php';
                    $sqla = "SELECT dessert.Dst_name, purchase.total_amount, dessert.Dst_type, purchase.customer_rating, purchase.customer_comment, purchase.quantity FROM purchase JOIN dessert ON purchase.Dst_ID = dessert.Dst_ID WHERE MB_ID ='".$_SESSION["UID"]."'";
