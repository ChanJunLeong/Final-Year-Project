      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
            <div class="changeo">
                ...
                <a href="productcookies.php" class="act">
          ...
          <div class="sales-details">
             ...
             <ul class="details">
            <li class="topic">Cookies Name</li>
                <?php
                    include 'database.php';
                    $sql = "SELECT * FROM cookies WHERE Cok_statu = 'Active'";
                    $result8 = mysqli_query($conn, $sql);
                    $result8Check = mysqli_num_rows($result8);
                    while($row = $result8->fetch_assoc())
                    {
                ?>
            <li><?php echo $row["Cok_name"]; ?></li>
                <?php
                    }
                ?>
          </ul>
            <ul class="details">
            <li class="topic">Cookies ID</li>
                <?php
                    include 'database.php';
                    $sqla = "SELECT * FROM cookies WHERE Cok_statu = 'Active'";
                    $result1 = mysqli_query($conn, $sqla);
                    $result1Check = mysqli_num_rows($result1);
                    while($row = $result1->fetch_assoc())
                    {
                ?>
            <li><?php echo $row["Cok_ID"]; ?></li>
                <?php
                    }
                ?>
          </ul>
            <ul class="details">
                <li class="topic">Cookies Flavor</li>
                <?php
                    include 'database.php';
                    $sqlb = "SELECT * FROM cookies WHERE Cok_statu = 'Active'";
            ...
            <ul class="details">
                <li class="topic">Cookies Price</li>
                <?php
                    include 'database.php';
                    $sqlb = "SELECT * FROM cookies WHERE Cok_statu = 'Active'";
                    $result2 = mysqli_query($conn, $sql);
                    ...
                    {
                ?>
            <li>RM<?php echo $row["Cok_price"]; ?></li>
                <?php
                    }
                ?>
            </ul>
          ...
          <div class="button">
            <a href="acookies.php">Add Cookies</a> 
            <a href="ecookies.php">Delete Cookies</a>
            <a href="editcookies.php">Edit Cookies</a>
          </div>
        </div>
      </div>
    </div>
