...
<h1><i class="fa-solid fa-wand-magic-sparkles"></i> Cookies <i class="fa-solid fa-wand-magic-sparkles"></i></h1>
<div class="grid-container">

    <?php
        include 'database.php';
        $sql = "SELECT Cok_name, Cok_image, Cok_price, Cok_ID, Flavor FROM cookies WHERE Cok_statu = 'Active'";
    ...
    ?>
	<div class="col">
		 <img src="image/<?php echo $row["Cok_image"]; ?>"/>
		<div class="content">
                <a href="" class="name" name="halo"><h3><?php echo $row["Cok_name"]?></h3>
                <p><i><?php echo $row["Flavor"]?><br/></i></p>
                <div class="price">RM<?php echo $row["Cok_price"]?></div>
                <div class="star">
                </div>
                    <br/>
                    <form method="post" name="x" action="eachcookies.php">
                        <input type="hidden" name="y" value="<?php echo $row["Cok_ID"]?>">
