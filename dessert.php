...
<h1><i class="fa-solid fa-wand-magic-sparkles"></i> Dessert <i class="fa-solid fa-wand-magic-sparkles"></i></h1>
<div class="grid-container">

    <?php
        include 'database.php';
        $sql = "SELECT Dst_name, Dst_img, Dst_price, Dst_ID, Flavor FROM dessert WHERE Dst_statu = 'Active'";
