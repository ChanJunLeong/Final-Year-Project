...
<body>
  ...
  <section class="home-section">
    ...
    <form method="POST">
      <h1>Delete Dessert</h1>
      <label for="name">Dessert ID:</label>
      <input type="text" name="did"  placeholder="Dessert ID to be delete" required/><br><br>
      ...
      <input type="submit" value="Delete Dessert" name="submit">
        <br>
        <br>
...
<?php
        function button1()
        {
            ...
            if($Spass == $pass2)
            {
                    $sql = "UPDATE dessert SET Dst_statu = 'SO' WHERE Dst_ID = '".$Did."'";
