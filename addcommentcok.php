    ...
    ?>
		<div class="form-container">
            ...
            <div class="buyh">
                <?php
                    include 'database.php';
                    $sqla = "SELECT cookies.Cok_name, purchase.total_amount, purchase.customer_rating, purchase.customer_comment, purchase.quantity FROM purchase JOIN cookies ON purchase.Cok_ID = cookies.Cok_ID WHERE MB_ID ='".$_SESSION["UID"]."'";
