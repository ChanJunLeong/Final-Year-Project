    ...
    <div class="contain">
		...
		<div class="info">
            <?php
                ...
                $sql = "SELECT MB_ID, MB_Name, MB_Email, MB_Phone_number, MB_Address FROM member WHERE MB_ID ='".$_SESSION["UID"]."'";
            ...
            ?>
			<p><strong>Username:</strong> <?php echo $row["MB_Name"]; ?></p>
			<p><strong>User ID:</strong> <?php echo $row["MB_ID"]; ?></p>
			<p><strong>Email:</strong> <?php echo $row["MB_Email"]; ?></p>
			<p><strong>Location:</strong> <?php echo $row["MB_Address"]; ?></p>
			<p><strong>Phone Number:</strong> <?php echo $row["MB_Phone_number"]; ?></p>
            <?php
            }
            else
            {
		...
		<a href="editprofile.php" class="button2">Edit Profile</a>
	</div>
