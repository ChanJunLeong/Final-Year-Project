...
<h1><i class="fa-solid fa-wand-magic-sparkles"></i> Fruit Cakes <i class="fa-solid fa-wand-magic-sparkles"></i></h1>
<div class="grid-container">

    <?php
        include 'database.php';
        $sql = "SELECT CK_Name, CK_img, CK_price, CK_ID, Flavor FROM cake WHERE CK_type = 'Fruit Cake' and CK_statu = 'Active'";
