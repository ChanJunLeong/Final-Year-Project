...
<h1><i class="fa-solid fa-wand-magic-sparkles"></i> Macaroon <i class="fa-solid fa-wand-magic-sparkles"></i></h1>
<div class="grid-container">

    <?php
        include 'database.php';
        $sql = "SELECT Dst_name, Dst_img, Dst_price, Dst_ID, Flavor FROM dessert WHERE Dst_type ='Macaroon' and Dst_statu = 'Active'";
    ...
    ?>
	<div class="col">
		<img src="image/<?php echo $row["Dst_img"]; ?>"/>
		<div class="content">
                <a href="" class="name" name="halo"><h3><?php echo $row["Dst_name"]?></h3>
                <p><i><?php echo $row["Flavor"]?><br/></i></p>
                <div class="price">RM<?php echo $row["Dst_price"]?></div>
                <br/>
                    <form method="post" name="x" action="eachdessert.php">
                        <input type="hidden" name="y" value="<?php echo $row["Dst_ID"]?>">
